...
/* harmony import */ var js2_transcode_worker_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! js2/transcode.worker.js */ "./src/js2/transcode.worker.js");
/* harmony import */ var js2_transcode_worker_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(js2_transcode_worker_js__WEBPACK_IMPORTED_MODULE_5__);
...
/* harmony import */ var js_base64__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! js-base64 */ "./node_modules/js-base64/base64.mjs");
...
var transWorker = new js_transcode_worker_js__WEBPACK_IMPORTED_MODULE_4___default.a();
var transWorker2 = new js2_transcode_worker_js__WEBPACK_IMPORTED_MODULE_5___default.a(); //APPID，APISecret，APIKey在控制台-我的应用-语音听写（流式版）页面获取

var APPID = 'abd9b965';
var API_SECRET = 'MTUyYjkzZjQzNGM2ODAzNjE4ZWU1Yjk2';
var API_KEY = '5c13bdf8d41a91e2558a1e284a43eaf4';
/**
 * 获取websocket url
  ...
  _createClass(TTSRecorder, [{
    ...
    value: function encodeText(text, encoding) {
      switch (encoding) {
        ...
        default:
          {
            return js_base64__WEBPACK_IMPORTED_MODULE_7__["Base64"].encode(text);
          }
      }
    } // websocket接收数据的处理
